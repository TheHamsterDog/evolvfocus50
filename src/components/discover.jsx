    ...
    return (
        <div className="discover">
            <div className="discover-content">
                <h2 className="discover-content-header">
                    Discover 50 Minor Tweaks That Can Unlock a Long Life of Freedom, Achievements, and Abundance.
                </h2>
                <p className="discover-content-paragraph">
                    Did you know that there are <u>50 simple tweaks</u> in your life that can dramatically change the course of your future?
                </p>
